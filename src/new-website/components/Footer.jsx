...
// Dark footer: brand blurb + link columns + contact + bottom bar
...
const columns = [
  {
    ...
    links: [
      ...
      { id: "pricing",  label: "Pricing",  href: "#nw-pricing" },
    ],
  },
  {
    id: "nw-foot-products",
  ...
  },
  {
    ...
    links: [
      ...
      { id: "demo",         label: "Book a Demo",    href: "#nw-demo" },
...
const socials = [
  ...
  { id: "nw-foot-ig", label: "Instagram", brand: "linear-gradient(45deg,#f09433,#dc2743,#bc1888)", href: "#",
