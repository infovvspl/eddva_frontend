...
export default function StudentCommunications({ heightClass = 'h-[calc(100dvh-150px)] sm:h-[calc(100dvh-200px)]' }) {
  ...
  return (
    <div className={`flex ${heightClass} min-h-0 w-full flex-col overflow-hidden pb-6 sm:pb-8`}>
      {!isSuperAdmin && (
      ...
      <div className={`flex-1 min-h-0 overflow-hidden bg-white flex flex-col md:flex-row relative transition-all mb-4 sm:mb-6 ${
        selectedUser
