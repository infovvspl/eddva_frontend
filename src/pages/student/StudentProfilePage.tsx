      ...
      >
        ...
        <div className="flex items-center justify-between px-8 py-6 border-b border-slate-100 relative z-10">
          <div className="flex items-center gap-3">
             <div className="w-10 h-10 rounded-xl bg-white flex items-center justify-center text-gray-900">
        ...
        <div className="p-8 space-y-6 relative z-10 overflow-y-auto max-h-[60vh] custom-scrollbar">
          ...
          <div className="pt-2">
            ...
            <div className="flex justify-between mt-2 text-[9px] font-black text-gray-600 px-1 uppercase tracking-widest">
               <span>Eco (1H)</span>
               <span>Boost (6H)</span>
               <span>Max (12H)</span>
            </div>
        ...
        <div className="p-8 border-t border-slate-100 relative z-10 bg-white">
          <button
            ...
            className="w-full py-5 rounded-[1.75rem] bg-white text-white text-xs font-black uppercase tracking-[0.3em] flex items-center justify-center gap-4 transition-all shadow-2xl hover:bg-blue-600"
          >
              ...
              {(["dna", "reports"] as const).map(t => (
                <button key={t} onClick={() => setTab(t)}
                  className={cn(
                    ...
                    tab === t ? "bg-white text-gray-900 shadow-lg" : "text-slate-400 hover:text-slate-600"
                  )}
                >
        ...
        {tab === "reports" ? (
          ...
          <div className="grid grid-cols-1 xl:grid-cols-4 gap-12 items-start pb-20">
            ...
            <div className="xl:col-span-1 space-y-8">
               ...
               {/* Achievement Panel */}
               <CardGlass className="p-8 bg-white border-gray-200 text-gray-900 overflow-hidden shadow-orange-500/10">
                  ...
                  <div className="grid grid-cols-3 gap-4 relative z-10">
                     {[Star, Zap, Shield, Flame, Target, Trophy].map((Icon, i) => (
                        <div key={i} className="aspect-square rounded-2xl bg-white/5 border border-gray-200 flex items-center justify-center group hover:bg-orange-500 hover:border-orange-400 transition-all cursor-pointer">
                           <Icon className="w-5 h-5 opacity-40 group-hover:opacity-100 group-hover:scale-110 transition-all" />
                        </div>
                     ))}
                  </div>
                  <button className="w-full mt-10 py-4 bg-white/5 border border-gray-200 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-white/10 transition-all">
                     Showcase All (14)
                  </button>
               </CardGlass>
            </div>
            ...
            <div className="xl:col-span-3 space-y-10">
               ...
               <CardGlass className="p-10">
                  <div className="flex items-center justify-between mb-10">
                     <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-white text-gray-900 flex items-center justify-center shadow-xl">
