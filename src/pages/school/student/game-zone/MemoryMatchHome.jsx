...
import { Play, Trophy, ArrowLeft, Loader2, Brain, Award, Check, ChevronRight, Zap, Flame, Snowflake } from 'lucide-react';
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`py-3 px-4 text-xs font-black rounded-lg border text-left transition flex flex-col gap-0.5 ${
                        mode === m.id
                          ? 'border-emerald-500 bg-emerald-50/20 text-emerald-750 dark:bg-emerald-950/20 dark:text-emerald-300'
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center justify-between p-4 rounded-xl border-2 text-left transition ${
                        isSelected
                          ? 'border-emerald-500 bg-emerald-50/20 text-emerald-950 dark:bg-emerald-950/10 dark:text-white'
