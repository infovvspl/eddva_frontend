      ...
      {badgeUnlocked && (
        <div className="rounded-2xl border border-indigo-200 bg-gradient-to-r from-indigo-50 via-white to-indigo-50/50 p-5 dark:border-indigo-900/40 dark:from-indigo-950/20 dark:to-slate-950 shadow-md flex items-center gap-4 animate-bounce-short">
          ...
          <div>
            ...
            <h3 className="text-base font-black text-slate-950 dark:text-white">🏆 Badge Unlocked: Math Speedster</h3>
            <p className="text-xs font-semibold text-slate-500">Unlocks by achieving a rapid score of 150+ in Math Sprint!</p>
          </div>
        </div>
      )}
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900">
        ...
        <div className="mt-6 border-t border-slate-100 dark:border-slate-800 pt-5 space-y-3">
          <div className="flex items-center justify-between text-sm font-black">
            <span className="text-slate-400">Arithmetic attempted</span>
            <span className="text-slate-800 dark:text-white">{questionsAttempted} equations</span>
          </div>

          <div className="flex items-center justify-between text-sm font-black">
            <span className="text-slate-400">Correct answers</span>
            <span className="text-emerald-600 dark:text-emerald-400">{correctAnswers} solved</span>
          </div>
