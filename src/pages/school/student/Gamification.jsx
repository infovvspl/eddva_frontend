...
export default function Gamification() {
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-black text-slate-900 dark:text-white">Gamification Center</h1>
        <p className="mt-1 text-xs sm:text-sm font-medium text-slate-500">Earn XP and EDDVA Coins from classes, homework, tests, and arcade games. Unlock badges and ranks.</p>
      </div>

      <div className="flex items-center gap-1.5 rounded-xl bg-slate-100 p-1 dark:bg-slate-800 w-full">
        <button
          onClick={() => setActiveTab('overview')}
          className={`flex-1 rounded-lg px-4 py-2 text-xs sm:text-sm font-bold transition ${activeTab === 'overview' ? 'bg-white text-slate-900 shadow-sm dark:bg-slate-700 dark:text-white' : 'text-slate-500 hover:text-slate-700 dark:text-slate-400'}`}
        >
          Overview
        </button>
        <button
          onClick={() => setActiveTab('issues')}
          className={`flex-1 rounded-lg px-4 py-2 text-xs sm:text-sm font-bold transition ${activeTab === 'issues' ? 'bg-white text-slate-900 shadow-sm dark:bg-slate-700 dark:text-white' : 'text-slate-500 hover:text-slate-700 dark:text-slate-400'}`}
        >
          Issues
        </button>
      </div>
      ...
      {activeTab === 'issues' && (
        <div className="rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 text-center shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <h2 className="text-base sm:text-lg font-bold text-slate-900 dark:text-white">Issues & Support</h2>
          <p className="mt-2 text-xs sm:text-sm text-slate-500">Report any issues related to Gamification here.</p>
        </div>
      )}

      {activeTab === 'overview' && (
        <div className="space-y-5 sm:space-y-6">
          <section className="rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 flex flex-col md:flex-row md:items-center justify-between gap-4">
            {/* Left: Level & Progress */}
            <div className="flex-1 flex flex-col justify-center min-w-[200px] max-w-md">
              <div className="flex items-center gap-2.5 mb-2">
                <span className="rounded-md bg-amber-50 px-2 py-0.5 text-[10px] font-black uppercase tracking-widest text-amber-700 dark:bg-amber-950/30 dark:text-amber-300">
                  {currentLevel} (Level {level})
                </span>
                <span className="text-[10px] font-bold text-slate-500">Next: {nextLevel}</span>
              </div>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between gap-3 mb-4 sm:mb-5">
              <div>
                <h2 className="text-base sm:text-lg font-black text-slate-900 dark:text-white">EDDVA Learning Arcade</h2>
                <p className="text-xs sm:text-sm font-medium text-slate-500 mt-0.5">Play NCERT-aligned games to boost your grades, earn XP, and collect EDDVA Coins!</p>
              </div>
              <Gamepad2 className="h-5 w-5 sm:h-6 sm:w-6 text-indigo-500 animate-bounce shrink-0" />
            </div>
              ...
              <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-gradient-to-br from-indigo-50/50 to-white p-4 sm:p-5 dark:border-slate-800 dark:from-slate-900/50 dark:to-slate-950 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg">
                <div>
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="rounded-full bg-indigo-50 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-indigo-700 dark:bg-indigo-950/20 dark:text-indigo-300">
                      Quiz Rush
                    </span>
                  </div>
                  <h3 className="mt-3.5 text-sm sm:text-base font-black text-slate-900 dark:text-white">Quiz Rush</h3>
              ...
              <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-gradient-to-br from-amber-50/50 to-white p-4 sm:p-5 dark:border-slate-800 dark:from-slate-900/50 dark:to-slate-950 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg">
                <div>
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="rounded-full bg-amber-50 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-amber-700 dark:bg-amber-950/20 dark:text-amber-300">
                      Treasure Hunt
                    </span>
                  </div>
                  <h3 className="mt-3.5 text-sm sm:text-base font-black text-slate-900 dark:text-white">Treasure Hunt</h3>
                  <p className="mt-1.5 text-xs font-medium text-slate-500 leading-relaxed">
              ...
              <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-gradient-to-br from-rose-50/50 to-white p-4 sm:p-5 dark:border-slate-800 dark:from-slate-900/50 dark:to-slate-950 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg">
                <div>
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="rounded-full bg-rose-50 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-rose-700 dark:bg-rose-950/20 dark:text-rose-300">
                      Math Sprint
                    </span>
                  </div>
                  <h3 className="mt-3.5 text-sm sm:text-base font-black text-slate-900 dark:text-white">Math Sprint</h3>
                  <p className="mt-1.5 text-xs font-medium text-slate-500 leading-relaxed">
              ...
              <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-gradient-to-br from-emerald-50/50 to-white p-4 sm:p-5 dark:border-slate-800 dark:from-slate-900/50 dark:to-slate-950 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg">
                <div>
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="rounded-full bg-emerald-50 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-emerald-700 dark:bg-emerald-950/20 dark:text-emerald-300">
                      Memory Match
                    </span>
                  </div>
                  <h3 className="mt-3.5 text-sm sm:text-base font-black text-slate-900 dark:text-white">Memory Match</h3>
                  <p className="mt-1.5 text-xs font-medium text-slate-500 leading-relaxed">
              ...
              <div className="flex flex-col justify-between rounded-xl border border-slate-200 bg-gradient-to-br from-violet-50/50 to-white p-4 sm:p-5 dark:border-slate-800 dark:from-slate-900/50 dark:to-slate-950 shadow-sm transition-all duration-300 hover:-translate-y-1.5 hover:shadow-lg">
                <div>
                  <div className="flex items-center gap-2.5">
                    ...
                    <span className="rounded-full bg-violet-50 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-violet-700 dark:bg-violet-950/20 dark:text-violet-300">
                      Word Master
                    </span>
                  </div>
                  <h3 className="mt-3.5 text-sm sm:text-base font-black text-slate-900 dark:text-white">Word Master</h3>
                  <p className="mt-1.5 text-xs font-medium text-slate-500 leading-relaxed">
