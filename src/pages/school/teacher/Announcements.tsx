    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm font-medium text-slate-500">Institute notices, exam notices, holiday notices, and notifications.</p>
        </div>
      ...
      <div className="grid gap-4 lg:grid-cols-4">
        <div className="rounded-lg border border-blue-100 bg-blue-50 p-5 dark:border-blue-900/40 dark:bg-blue-950/20">
          ...
          <p className="mt-4 text-[11px] font-black uppercase tracking-widest text-blue-700 dark:text-blue-300">New Notices</p>
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 dark:border-slate-800 dark:bg-slate-900">
          ...
          <p className="mt-4 text-[11px] font-black uppercase tracking-widest text-slate-500">Notifications</p>
