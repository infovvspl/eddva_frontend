...
export default function Institutes() {
  ...
  function toEditForm(institute) {
    return {
      ...
      aiEnabled: enabledFromApi(institute?.aiEnabled ?? institute?.ai_enabled),
      aiFeatures: institute?.aiFeatures ?? institute?.ai_features ?? { ...emptyForm.aiFeatures },
    };
  }
  ...
  async function loadInstitutes(showLoader = true) {
    try {
      ...
      const mappedList = rawList.map(item => ({
        ...
        aiEnabled: enabledFromApi(item.aiEnabled ?? item.ai_enabled),
        aiFeatures: item.aiFeatures || item.ai_features || {},
      }));
