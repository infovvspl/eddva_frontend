  ...
  return (
    <div className="w-full px-3 sm:px-5 lg:px-8 xl:px-10">
      ...
      <div className="grid grid-cols-2 gap-2 sm:gap-3 xl:grid-cols-4">
        {[
          ...
          <motion.div
            ...
            className="glass-premium rounded-2xl p-3 sm:p-4"
          >
            <div className="flex items-start justify-between gap-2 sm:gap-3">
              <div className="min-w-0">
                <p className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 truncate">{card.title}</p>
                <p className="mt-1 sm:mt-2 font-display text-xl sm:text-3xl font-bold text-slate-950 dark:text-white">
      ...
      <div className="mt-5 glass-premium rounded-2xl">
        <div className="relative z-20 border-b border-[rgba(37,99,235,0.10)] bg-white/60 px-4 py-4 backdrop-blur dark:border-slate-700 dark:bg-slate-900/40 space-y-3">
          ...
          <div className="flex flex-col md:hidden gap-3">
            <div className="flex items-center justify-between gap-2">
              <div className="inline-flex items-center gap-1.5 rounded-full border border-[rgba(37,99,235,0.12)] bg-white/90 px-2.5 py-1 text-xs font-semibold text-slate-700 dark:border-slate-700 dark:bg-slate-900">
              ...
              <button
                ...
                className={cn(
                  ...
                  showMobileFilters
                    ...
                    : "bg-white border-[rgba(37,99,235,0.14)] text-slate-700"
                )}
              >
            ...
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full rounded-2xl border border-[rgba(37,99,235,0.12)] bg-white py-2 pl-9 pr-3 text-sm font-semibold text-slate-900 outline-none placeholder:text-slate-400 dark:border-slate-700 dark:bg-slate-900 dark:text-white"
              />
            </div>
            ...
            {showMobileFilters && (
              <div className="flex flex-col gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                <CustomSelect
                  ...
                  className="w-full"
                  triggerClassName="flex h-full w-full items-center justify-between gap-2 px-3 py-2 rounded-2xl border border-[rgba(37,99,235,0.12)] bg-white text-sm font-semibold text-slate-700"
                />
                ...
                <div className="flex items-center gap-2 rounded-2xl border border-[rgba(37,99,235,0.12)] bg-white px-3 py-2 text-sm font-semibold text-slate-700">
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  <button
                    ...
                    className="flex items-center justify-center rounded-2xl border border-[rgba(37,99,235,0.14)] bg-white px-4 py-2 text-xs font-bold text-slate-700 shadow-sm"
                  >
                    Clear Filters
                  </button>
                  <button
                    type="button"
                    onClick={exportCsv}
                    className="flex items-center justify-center gap-2 rounded-2xl border border-[rgba(37,99,235,0.14)] bg-white px-4 py-2 text-xs font-bold text-slate-700 shadow-sm"
                  >
        ...
        {/* Mobile View */}
        <div className="block md:hidden divide-y divide-slate-100 dark:divide-slate-800 bg-white dark:bg-slate-900 rounded-b-2xl overflow-hidden border border-t-0 border-slate-100 dark:border-slate-800">
          {filtered.length === 0 ? (
              ...
              <div key={teacher.id} className="p-4 space-y-3 hover:bg-blue-50/40 dark:hover:bg-slate-800/40 transition">
                ...
                <div className="grid grid-cols-2 gap-y-3 gap-x-4 text-xs text-slate-600 dark:text-slate-300 pt-1">
                  <div>
                    ...
                    <span className="font-bold">{teacher.instituteName || '-'}</span>
                  </div>
                  <div className="min-w-0">
                    <span className="block text-[9px] uppercase tracking-wider text-slate-400 font-black">Email</span>
                    <span className="font-bold truncate block">{teacher.email || '-'}</span>
                  </div>
                  <div>
                  ...
                  <div>
                    <span className="block text-[9px] uppercase tracking-wider text-slate-400 font-black">Status</span>
                    <button
                      onClick={async () => {
                        try {
                          const newActive = !teacher.isActive;
                      ...
                      className="flex items-center gap-1.5 outline-none group cursor-pointer mt-0.5"
                      title="Click to toggle status"
                    >
                      <div className={cn(
                        "relative w-9 h-5 rounded-full transition-colors duration-200 flex items-center px-0.5 border",
                ...
                <div className="flex items-center justify-end gap-2 pt-2.5 border-t border-slate-50 dark:border-slate-800/40">
                  <Link
                    to={`/school/admin/teachers/${teacher.id}`}
