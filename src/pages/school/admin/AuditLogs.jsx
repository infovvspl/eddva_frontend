...
export default function AuditLogsPage() {
  ...
  return (
    <div className="space-y-6 pb-12 px-0 md:px-6 pt-4 min-h-screen bg-slate-50/50">
      {/* Upper Header Card */}
      <div className="relative rounded-none sm:rounded-2xl bg-gradient-to-r from-slate-900 via-indigo-950 to-slate-900 p-4 md:p-8 shadow-xl overflow-hidden border-b sm:border border-indigo-900/30">
        ...
        <div className="relative flex flex-row justify-between items-center gap-4">
          <div className="min-w-0 flex-1">
            <h1 className="font-display text-xl md:text-3xl font-extrabold text-white tracking-tight">System Audit Logs</h1>
            <p className="mt-2 text-indigo-200/80 text-sm max-w-xl hidden md:block">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 md:px-5 md:py-2.5 bg-indigo-600 hover:bg-indigo-500 disabled:bg-indigo-800/50 text-white rounded-xl font-semibold shadow-lg hover:shadow-indigo-600/30 transition-all duration-200 text-xs md:text-sm disabled:cursor-not-allowed group border border-indigo-500/50 shrink-0"
          >
            {exporting ? (
      ...
      <div className="rounded-none sm:rounded-2xl border-y sm:border border-slate-200/80 bg-white p-4 sm:p-5 shadow-sm space-y-4">
          ...
          {showMobileFilters && (
            <div className="flex flex-col gap-3 pt-2 border-t border-slate-100">
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-2.5 py-1.5 border border-slate-200 rounded-xl text-xs outline-none text-slate-700 bg-white"
                  />
                </div>
                <div>
              ...
              <div className="space-y-2">
                <div>
                  <label className="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Module</label>
                  <CustomSelect
                ...
                <div>
                  ...
                  <CustomSelect
                    value={selectedRole}
                    onChange={(val) => { setSelectedRole(val); setPage(1); }}
                    options={
                      isSuperAdmin
                        ? [
                ...
                {isSuperAdmin ? (
                  <div>
                    <label className="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Institute</label>
                    <CustomSelect
                      value={selectedInstitute}
                      onChange={(val) => { setSelectedInstitute(val); setPage(1); }}
                      options={[
                        { value: "ALL", label: "All Institutes" },
                        ...institutesList.map((inst) => ({ value: inst.id, label: inst.name })),
                      ]}
                      className="w-full"
                    />
                  </div>
                  ...
                  <div>
                    <label className="block text-[10px] font-semibold text-slate-500 uppercase tracking-wider mb-1">Actor</label>
                    <CustomSelect
                      value={selectedUser}
                      onChange={(val) => { setSelectedUser(val); setPage(1); }}
                      options={[
                        { value: "ALL", label: "All Users" },
                        ...actorsList.map((actor) => ({ value: actor.id, label: actor.name })),
                      ]}
                      className="w-full"
                    />
                  </div>
