...
export default function LiveUsagePage() {
  const { data, isLoading } = useQuery<LiveUsageData>({
    queryKey: ['coaching-live-usage'],
    queryFn: getCoachingLiveUsage,
  ...
  return (
    <div className="w-full space-y-4 sm:space-y-6 font-poppins text-slate-900">
      <header className="mb-4 sm:mb-8 bg-blue-100 border border-blue-200/80 rounded-2xl px-5 pt-5 pb-3.5 sm:p-6 shadow-xl shadow-indigo-500/10 hover:shadow-2xl hover:shadow-indigo-500/15 transition-all duration-300 dark:bg-blue-950/20 dark:border-blue-900/50">
          ...
          <p className="text-slate-400 text-sm mt-1 font-semibold">
            Realtime and historical live streaming analytics across all coaching institutes
          </p>
        </header>
