                      ...
                      <div className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <button
                            ...
                            className={`flex flex-col p-6 rounded-3xl border-2 text-left transition-all relative ${
                                ...
                                <div className="flex items-center self-center">
                                  <button
                                    ...
                                    className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none ${
                                      isEnabled && !p.disabled ? "bg-indigo-600" : "bg-slate-200"
                                    } ${p.disabled ? "cursor-not-allowed opacity-50" : "cursor-pointer"}`}
                                  >
                                    <span
                                      className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                                        isEnabled && !p.disabled ? "translate-x-6" : "translate-x-1"
                                      }`}
                                    />
                                  </button>
                                </div>
