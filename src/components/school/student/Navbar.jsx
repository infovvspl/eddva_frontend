      ...
      <div className="flex items-center justify-between gap-3 sm:gap-8">
        ...
        <div className="flex items-center gap-3">
          <div className="relative flex items-center gap-2" ref={notifRef}>
            ...
            {notifOpen && (
              <div className="fixed left-4 right-4 top-[72px] z-50 sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-4 w-auto sm:w-96 max-w-none overflow-hidden rounded-[2rem] border border-slate-100 bg-white py-2 shadow-2xl dark:border-slate-800 dark:bg-slate-900">
                {/* Header */}
