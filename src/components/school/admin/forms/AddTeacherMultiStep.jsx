  ...
  return (
    <div className="mb-4 sm:mb-8">
      <div className="flex flex-wrap items-center gap-2 mb-1">
        ...
        {badge && (
          <span className="px-2 py-0.5 rounded-full bg-blue-500/10 text-blue-600 dark:text-sky-400 text-[9px] font-bold uppercase tracking-wider border border-blue-500/20">
            {badge}
          </span>
        )}
      </div>
  ...
  return (
    <div className={`flex flex-col overflow-hidden bg-slate-50 dark:bg-slate-950 lg:flex-row ${pageMode ? 'min-h-[calc(100vh-150px)] rounded-[20px] lg:h-[calc(100vh-168px)] lg:min-h-[620px] lg:rounded-[24px]' : 'h-[calc(90vh-88px)] min-h-[520px]'}`}>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        <main className="flex-1 overflow-y-auto bg-white px-3 py-4 dark:bg-slate-950 sm:px-5 lg:px-6 custom-scrollbar">
