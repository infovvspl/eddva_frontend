        ...
        return (
          <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FloatingInput label="Father's Name" name="fatherName" value={formData.fatherName} onChange={handleChange} icon={User} error={errors.fatherName} required />
              <FloatingInput label="Mother's Name" name="motherName" value={formData.motherName} onChange={handleChange} icon={User} error={errors.motherName} required />
              <FloatingInput label="Parent Phone" name="parentPhone" value={formData.parentPhone} onChange={handleChange} icon={Smartphone} error={errors.parentPhone} required />
            ...
            <button 
              onClick={() => {
                if (currentStep < STEPS.length) {
                  ...
                  // Validate final submit across all steps
                  let isValid = true;
