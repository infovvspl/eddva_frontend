  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#F8FAFC] font-sans text-gray-900 antialiased">
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.93 }}
        className="fixed bottom-32 right-4 z-50 flex h-12 w-12 items-center justify-center rounded-full text-white shadow-2xl sm:bottom-28 sm:right-6 sm:h-14 sm:w-14"
